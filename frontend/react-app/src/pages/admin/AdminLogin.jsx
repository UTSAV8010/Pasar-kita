  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response && response.status === 'redirect') {
        addAlert('Admin logged in successfully!', 'success');
      ...
      console.error(err);
      addAlert('Invalid admin username or password.', 'danger');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      ...
      <div className="auth-shell">
        ...
        <p class="auth-subtitle">Please enter your credentials to access the admin panel.</p>
        ...
        <div className="auth-footer">
          <Link className="link-inline" to="/admin/forget">Forgot Password?</Link>
          <span>New here? <Link className="link-inline" to="/admin/signup">Create Account</Link></span>
        </div>
      </div>
    </>
  );
